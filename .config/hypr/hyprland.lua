...
hl.config({
    misc = {
        ...
        focus_on_activate       = true,  -- Switch to workspace when a window requests focus
    },
})
...
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call launcher toggle"))  -- Noctalia app launcher
...
hl.window_rule({
    ...
    name  = "steam-notifications-focus",
    match = { class = "steam", xwayland = true },
    no_focus = false,
})
